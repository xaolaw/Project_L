...
public class AnimalSimulation extends JPanel  {
    ...
    public AnimalSimulation(MapSimulation2 simulation2, IEngine engine){
    ...
    public void paintComponent(Graphics g){
        ...
        this.setSize((int) (simulation2.frame.getWidth()*0.6),simulation2.frame.getHeight()-38);
        this.setLocation((int) (0.4 * simulation2.frame.getWidth()), 0);
